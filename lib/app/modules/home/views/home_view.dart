                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          itemCount: controller.cabins.length + 1, // Add one for the button row
                          itemBuilder: (context, index) {
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        border: Border(
                                          top: BorderSide(
                                            color: Colors.grey.shade600, // Top border color
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: Colors.grey.shade800, // Background color for the container
                                        borderRadius: BorderRadius.zero, // Rectangular shape
                                      ),
                                      height: 72, // Set a fixed height to match the buttons
                                      child: Center(
                                        child: Text(
                                          controller.waitingTimes[controller.cabins.last.id] ?? '0:00', // Display the last cabin's waiting time
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 14,
                                            fontWeight: FontWeight.bold,
                                  ...
                                  Expanded(
                                    child: ElevatedButton(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Column(
                                          mainAxisSize: MainAxisSize.min, // Ensure the column takes minimal space, but can expand if needed
                                          mainAxisAlignment: MainAxisAlignment.start, // Align the content to the top of the button
                                          crossAxisAlignment: CrossAxisAlignment.center, // Center the content horizontally
                                          children: [
                                            // Image from assets
                                            Image.asset(
                                              'assets/icon/ex.jpeg', // Path to your image
                                              width: 36, // Set the size of the image to match your desired icon size
                                              height: 36,
                                  ...
                                  Expanded(
                                    child: ElevatedButton(
                                      ...
                                      child: const Padding(
                                        ...
                                        child: Column(
                                          mainAxisSize: MainAxisSize.max, // Ensures the column takes up full height
                                          children: [
                                            Icon(Icons.check, size: 42,color: Colors.white,), // Icon above
                                           // Space between icon and text
                                            Text("Accept", style: TextStyle(fontSize: 12,color: Colors.white)), // Text below the icon
                                          ],
                                        ),
                                      ),
                                    ),
